...
<html>
	...
	<body>
		...
		<img style="width: 75px;height: 50px;border: 0;margin-top: 10px;float: left;" src="<c:url value="/resources/pics/logo.jpg"></c:url>">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					<a class="navbar-brand" href="#"><b>FashionandJewellery</b></a>
				</div>
  ...
  <url:url value="/admin/product/productform" var="url"></url:url>
   <li><a href="${url }"><b>Add New Product</b></a></li>
    ...
    <li><a href="${cart }"><span class="on" ><b>Cart</b> <span id="show"></span></span></a></li></c:if>
